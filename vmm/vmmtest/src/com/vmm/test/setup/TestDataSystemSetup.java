...
import com.vmm.test.constants.VmmTestConstants;
import com.vmm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = VmmTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/vmmtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/vmmtest/import/reviews.impex");
			...
			importImpexFile(context, "/vmmtest/import/cstickets.impex");
		}
	}
}
