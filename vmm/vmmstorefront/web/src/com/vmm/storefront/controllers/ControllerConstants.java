 ...
 */
package com.vmm.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String LastBrowsedProductCarouselComponent = _Prefix + LastBrowsedProductCarouselComponentModel._TYPECODE + _Suffix; // NOSONAR
		}
	}
