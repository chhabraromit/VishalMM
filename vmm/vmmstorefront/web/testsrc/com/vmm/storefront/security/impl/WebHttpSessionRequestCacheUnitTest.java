...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vmmstorefront/electronics/en",
						"https://electronics.local:9002/vmmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vmmstorefront/electronics/en",
						"https://electronics.local:9002/vmmstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vmmstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/vmmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vmmstorefront/electronics/en",
						"https://electronics.local:9002/vmmstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vmmstorefront",
						"https://electronics.local:9002/vmmstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vmmstorefront",
						"https://electronics.local:9002/vmmstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/vmmstorefront/electronics/en",
						"https://electronics.local:9002/vmmstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
