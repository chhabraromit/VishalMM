 ...
 */
package com.vmm.storefront.interceptors;
...
import com.vmm.storefront.util.CSRFHandlerInterceptor;
import com.vmm.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "com.vmm.storefront.util.CSRFTokenManager.tokenval";
