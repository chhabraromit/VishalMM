 ...
 */
package com.vmm.cockpits.setup;
...
import com.vmm.cockpits.constants.VmmCockpitsConstants;
 ...
 */
@SystemSetup(extension = VmmCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(VmmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(VmmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						VmmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/vmmcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
