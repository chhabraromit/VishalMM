 ...
 */
package com.vmm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(VmmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(VmmFulfilmentProcessConstants.PARENT_PROCESS);
